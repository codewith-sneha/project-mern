            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Features</a>
                  <a href="#" className="text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Pricing</a>
                  <a href="#" className="text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Disabled</a>
                </div>
              </div>
            </div>
          </div>
