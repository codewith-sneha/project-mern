    ...
    <div className='sticky-nav'>
      ...
      <nav className="shadow-md shadow-black/5 dark:border-gray-700 bg-nav " style={{ height: "70px", }}>
        <div className="max-w-screen-xl flex flex-wrap justify-between items-center " style={{ height: "100%" }}>
          ...
          <button data-collapse-toggle="navbar-solid-bg" type="button" className="inline-flex items-center p-1 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-solid-bg" aria-expanded="false">
          ...
          <div className=" w-full md:block md:w-auto" id="navbar-solid-bg">
            <ul className="mediali flex flex-col font-medium mt-2 rounded-lg bg-gray-50 md:space-x-2 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700 text-base">
              <li>
                <Link to="/" className="block py-2 px-3 md:py-0 md:px-1 md:p-0 text-black bg-blue-700 rounded md:bg-transparent  md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent md:hover:text-white btnnav" aria-current="page">Home</Link>
              </li>
              <li>
                <Link to="/About" className="btnnav block py-2 px-3 md:py-0 md:px-1 md:p-0 text-black rounded  md:hover:bg-transparent md:border-0 md:hover:text-white dark:text-white md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ">About</Link>
              </li>
              <li>
